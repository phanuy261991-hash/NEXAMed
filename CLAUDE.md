...
**Sổ quỹ & Thu chi tại quầy (chốt 2026-09-05, `docs/DECISIONS.md` #121/#122, kế hoạch kỹ thuật đầy đủ ở `reactive-moseying-flask.md`)**: mở rộng tiếp của "Thu ngân cơ bản" — lý do: thu ngân chi/thu tiền mặt ngoài dịch vụ khám (tiền điện, tiền nước...) trước đây không có chỗ ghi, làm "Chốt ca" luôn lệch phải giải trình. Gồm: bảng `cash_account` (Quỹ tiền mặt/ngân hàng theo tenant, có số dư đầu kỳ) + `cash_voucher` (Phiếu thu/Phiếu chi ngoài dịch vụ khám, có thể yêu cầu duyệt) — **Giai đoạn 1 đã xong** (lập phiếu, in phiếu, tự cộng/trừ vào "Tiền mặt dự kiến trong két" của Chốt ca). **Giai đoạn 2** (đang làm): Sổ quỹ (liệt kê chứng từ theo quỹ, số dư luỹ kế) + Báo cáo dòng tiền (bảng kê thu/chi/tồn quỹ theo khoảng ngày, nhóm theo Loại thu chi/theo quỹ, xuất Excel — **KHÔNG** phải "báo cáo doanh thu theo kỳ" bị loại ở dòng dưới: không doanh thu, không công nợ, không lãi/lỗ) + tuỳ chọn "Thủ quỹ riêng" (mỗi thu ngân 1 két `DRAWER`) + phiếu "Chuyển quỹ" thủ công (di chuyển tiền giữa 2 quỹ nội bộ, không phải Thu/Chi thật).
