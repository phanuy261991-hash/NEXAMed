...
**Lưu ý đồng bộ tài liệu**: GĐ3 (Xuất kho theo đơn + FEFO + tiền thuốc, `stock_issue`/`stock_issue_line`, docs/DECISIONS.md #163/#164) và GĐ4 phần "Kiểm kê" (`stock_count`/`stock_count_line`, #170) đã hiện thực THẬT (đang chạy tại pilot) nhưng chưa từng được ghi vào mục 3 này — nợ tài liệu có sẵn từ trước, ngoài phạm vi phiên hiện tại (chỉ thêm mục 3.9 cho "Điều chuyển kho"). Xem `docs/DECISIONS.md` #163/#164/#170 để nắm đúng schema 2 phần đó trong lúc chờ bổ sung.
