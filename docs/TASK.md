...
- [ ] S1-02 — Prisma schema nền: 8 cột bắt buộc, base model, quy ước migration, `code_sequence`
- [ ] S1-03 — Tenant context: middleware `app.current_tenant_id`, RLS policy, unit of work
...
- [ ] CI fail khi migration tạo bảng thiếu một trong 8 cột bắt buộc
