...
const MODULE_LABELS: Record<string, string> = {
  ...
  drug: 'Danh mục Thuốc, Vật tư & Nhà cung cấp',
  invoice: 'Phiếu thu',
  ...
  // Kho Thuốc GĐ4, phần "Kiểm kê" (docs/DECISIONS.md #170) — thêm nhãn NGAY từ đầu, tránh lặp lại
  // lỗ hổng đã ghi chú nhiều lần ở trên.
