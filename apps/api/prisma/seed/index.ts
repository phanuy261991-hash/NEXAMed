...
import { seedAllergenCatalog } from '../../src/infrastructure/persistence/seed-allergen-catalog';
...
async function main() {
  ...
  try {
    ...
    await seedAllergenCatalog(prisma);
    console.log('✓ Seed allergen catalog xong.');
  } finally {
