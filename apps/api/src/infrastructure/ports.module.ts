...
import { BACKUP_STATUS_PORT, EVENT_BUS_PORT, INSURANCE_GATEWAY_PORT, PATIENT_IDENTITY_PORT, SIGNATURE_PORT, STORAGE_PORT } from '@nexamed/core';
...
@Module({
  ...
  exports: [STORAGE_PORT, EVENT_BUS_PORT, SIGNATURE_PORT, INSURANCE_GATEWAY_PORT, PATIENT_IDENTITY_PORT, BACKUP_STATUS_PORT],
})
